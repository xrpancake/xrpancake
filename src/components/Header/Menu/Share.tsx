...
const Share = () => {
  ...
  const shareTitle = 'Earn Ripple (XRP) and PancakeSwap (Cake) every hour';
  const shareUrl = 'https://www.xrpancake.com';
  ...
  return (
    <>
      ...
      <Modal
        ...
        closeTimeoutMS={300}
      >
        <ShareHeading>Let others know about XRPP</ShareHeading>
